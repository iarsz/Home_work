namespace Task_2_2
{
    internal class Program
    {
        ...
        {
            //Угол а задан в градусах, минутах и секундах. Найти его величину
            //в радианах. Рекомендации по тестированию: проверить работоспособность
            //программы для углов, больших развернутого.
